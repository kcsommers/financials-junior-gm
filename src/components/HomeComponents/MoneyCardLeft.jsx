...
import '../../css/MoneyLeftCard.css';

function MoneyCardLeft() {
  return (
    <div className="team-rank-card">
        <div className="team-rank-circle"><h1>85</h1></div>
        
        <div className="team-rank-hockey-stick-box">
          <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="212.309" height="210.76" viewBox="0 0 212.309 210.76">
            <defs>
              <clipPath id="clipPath">
                <rect id="Rectangle_68" data-name="Rectangle 68" width="64" height="160" transform="translate(70 144)" fill="none" stroke="#707070" strokeWidth="1"/>
              </clipPath>
            </defs>
