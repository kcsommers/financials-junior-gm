...
import seasonStick from '../../assets/images/icons/season-stick.svg';
import sharksLogo from '../../assets/images/icons/sharks-logo.svg';
import comericaLogo from '../../assets/images/icons/comerica-logo.svg';
import jrSharksLogoWhiteBg from '../../assets/images/icons/jr-sharks-logo-white-bg.svg';
import {ObjectivesBoard, TeamRankStick, OpposingTeamRankStick} from '../components/public-api';
import '../../assets/css/pages/season.css';
            ...
            <div className="teams-jumbotron">
              ...
              <div className="season-teams-playing-box">
                ...
                <div className="next-opponent-details">
                  <p className="next-opponent-name">Blue<br/> Bears</p>
                  <div className="sotr-details">
                    <SticklessOpposingTeamRank/>
                    <p className="season-tr-title">Team<br/> Rank</p>
                  </div>
                </div>
              </div>
              <div className="season-team-right-border"></div>
            </div>
            <div className="ready-to-play-sign">Your team is ready to play.</div>
          </div>
          <div style={{paddingTop: '1rem'}}>
