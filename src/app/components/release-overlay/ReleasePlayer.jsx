...
import {TeamBudgetState, FilledPlayerCard, PlayerReleased} from '../public-api';
...
export const ReleasePlayer = () => {
  ...
  return (
    <div className="release-dashboard">
      ...
      <p className="release-player-question">Are you sure you want to release the following player?</p>
