...
export const Jumbotron = ({
  ...
  const animationStates = {
    stats: useAppSelector((state) => state.tutorial.season.stats),
    upcomingGames: useAppSelector(
      (state) => state.tutorial.season.upcomingGames
    ),
    jumboText: useAppSelector((state) => state.tutorial.season.jumbotext),
  };
