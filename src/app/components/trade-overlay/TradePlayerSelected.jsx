...
import {TeamRankStick, MoneyLeftStick, Cancel, FilledPlayerCard, LevelStick, PlayerTraded, TeamBudgetState} from '../public-api';
...
export const TradePlayerSelected = () => {
  ...
  return (
    <div className="trade-dashboard">
      ...
      <p className="trade-player-question">Are you sure you want to trade Player with Player?</p>
