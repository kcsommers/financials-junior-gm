...
function Navigation() {
  return (
    <div className='nav-menu'>
      <div className='exit-hockey-stick-box'>
        {/* exit hockey stick link */}
        <svg
          className='exit-hockey-stick'
              ...
              <g id='Shape' transform='translate(0)'>
                <g id='Group_1' data-name='Group 1' transform='translate(0)'>
                  <g
                    id='Layer_2'
                    data-name='Layer 2'
                    transform='translate(0 235.207)'
                  >
                    <g id='logos'>
                      <path
                        id='Path_4'
                        data-name='Path 4'
                        d='M110.169,344.823c2.659,0,5.482-3.376,4.775-7.883l-3.724-21.515c-.447-3.126-2.413-5.387-4.693-5.394H8.44c-2.235.083-4.179,2.314-4.655,5.394L.1,336.94c-.685,4.507,2.138,7.906,4.76,7.883h105.3'
      ...
      <div className='home-title-box'>
        ...
        >
          ...
          <g transform='matrix(1, 0, 0, 1, 0, 0)' filter='url(#HOME_)'>
            <text
              id='HOME_2'
              data-name='HOME '
          ...
          <g id='settings-svgrepo-com' transform='translate(12.477 11.999)'>
            ...
            >
              ...
              <path
                id='Path_47'
                data-name='Path 47'
                d='M144.732,136a8.632,8.632,0,1,0,8.632,8.632A8.637,8.637,0,0,0,144.732,136Zm0,15.007a6.376,6.376,0,1,1,6.376-6.376A6.38,6.38,0,0,1,144.732,151.008Z'
                transform='translate(-124.728 -124.637)'
                fill='#fff'
              />
            </g>
          </g>
