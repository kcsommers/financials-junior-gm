export const TeamStickSvg = () => {
  return (
    <svg
      id="Team_Button_-_Main"
      data-name="Team Button - Main"
    ...
    >
      ...
      >
        ...
        <g id="Icon-2" data-name="Icon" transform="translate(501.887 687.119)">
          <g id="Layer_1-2" data-name="Layer 1" transform="translate(0 0)">
            <g
              id="Group_18-2"
              data-name="Group 18"
              transform="translate(82.453 0)"
            >
              <path
                id="Path_7-2"
                data-name="Path 7"
